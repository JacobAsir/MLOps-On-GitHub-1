...
if __name__ == "__main__":
    # Configuration
    data_file = "Bank_Customer_Churn_Prediction.csv"  # Path to your dataset
    target_col = "churn"  # Target column
    drop_cols = ["customer_id"]  # Columns to drop
    # Updated indices after dropping 'RowNumber', 'CustomerId', 'Surname'
    cat_columns = [1,2,6,7,8]  # 'Geography', 'Gender' after dropping columns
    num_columns = [0,3,4,5,9]  # Remaining numerical columns
